#!/usr/bin/env python3
"""
Integration tests for generate_results.py
...
# Add _scripts directory to path to import generate_results
_scripts_dir = Path(__file__).parent.parent / "_scripts"
sys.path.insert(0, str(_scripts_dir))

from generate_results import ResultsGenerator  # noqa: E402
